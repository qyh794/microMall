...
type ProductService interface {
	...
	DeleteProductByID(ctx context.Context, in *ProductInfo, opts ...client.CallOption) (*Response, error)
...
func (c *productService) DeleteProductByID(ctx context.Context, in *ProductInfo, opts ...client.CallOption) (*Response, error) {
...
type ProductHandler interface {
	...
	DeleteProductByID(context.Context, *ProductInfo, *Response) error
...
func RegisterProductHandler(s server.Server, hdlr ProductHandler, opts ...server.HandlerOption) error {
	type product interface {
		...
		DeleteProductByID(ctx context.Context, in *ProductInfo, out *Response) error
...
func (h *productHandler) DeleteProductByID(ctx context.Context, in *ProductInfo, out *Response) error {
